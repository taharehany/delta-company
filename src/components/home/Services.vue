...
section(class="services")
    div(class="container")
        div(class="main-title")
            span(class="top-title") {{ $t("services") }}
            h2 {{ $t("our_practice_area") }}
        div(class="content")
            div(class="row")
                div(class="col-lg-4 col-md-6 box" v-for="service in servicesData.slice(0, 6)" :key="service.id")
